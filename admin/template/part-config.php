...
<div class="bir-config-info"><?php _e('Choose how to optimize your images. No need to save. The settings are also applied to newly uploaded images.<br>Don\'t disable the plugin when you are done optimizing images, so the settings will also be applied to newly uploaded images.', 'wptimize'); ?></div>
<form id="opBulkImageResizerSetup">
    ...
    <div class="bir-config-box js-config-box">
        <div class="bir-config-row">
            <div class="op-form-field-small">
                ...
                <span class="bir-switch-label-active">(<?php _e('active', 'wptimize'); ?>)</span>
                <span class="bir-switch-label-noactive">(<?php _e('non active', 'wptimize'); ?>)</span>
            </div>

            </div>
            <div class="bir-config-title"><?php _e('Resize', 'wptimize'); ?></div>
        
            <div class="op-form-row bir-default-configuration">
                <div class="op-form-label"><?php _e('Dimensions', 'wptimize'); ?></div>
        ...
        <div class="bir-advanced-row-info"><?php _e('Crop uploaded images if higher than the selected settings', 'wptimize'); ?></div>
            <div class="op-grid-3-col">
                <div class="op-form-row js-custom-dimension">
                    <div class="op-form-label-big"><?php _e('Max width', 'wptimize'); ?></div>
                    <div class="op-form-field-small">
                        <input class="js-running-input-disable" name="max_width" type="number" id="resizeMaxWidth" value="<?php echo $options->max_width; ?>">
                    </div>
                </div>
                <div class="op-form-row js-custom-dimension">
                    <div class="op-form-label-big"><?php _e('Max height', 'wptimize'); ?></div>
                    <div class="op-form-field-small">
    ...
    <div class="bir-config-box js-config-box">
        <div class="bir-config-row">
            ...
            <div class="bir-config-title"><?php _e('Convert To WEBP', 'wptimize'); ?></div>
            <div class="op-form-row bir-default-configuration"></div>
           
        </div>
        <div class="bir-config-advanced-row js-config-advanced">
            <div class="bir-advanced-row-info"><?php _e('Converts images to WEBP. The WebP format improves image compression at the same quality and allows PNG images to be compressed', 'wptimize'); ?></div>
        </div>
    </div>
    ...
    <div class="bir-config-box js-config-box">
        <div class="bir-config-row">
            ...
            <div class="bir-config-title"><?php _e('Optimize', 'wptimize'); ?></div>
        
            <div class="op-form-row bir-default-configuration">
                <div class="op-form-label"><?php _e('Compression Quality', 'wptimize'); ?></div>
                <div class="op-form-field">
        ...
        <div class="bir-config-advanced-row js-config-advanced">
            <div class="bir-advanced-row-info"><?php _e('Optimize image compression. Low has lower quality, but lighter images, hight maximum quality, but heavier images.<br><b>If you don\'t have any particular needs, medium is fine.</b>', 'wptimize'); ?>
                </div>
        </div>
    </div>
    ...
    <div class="bir-config-box js-config-box">
        <div class="bir-config-row">
            ...
            <div class="bir-config-title"><?php _e('Rename File', 'wptimize'); ?></div>
        
            <div class="op-form-row bir-default-configuration">
                <div class="op-form-label"><?php _e('New Name', 'wptimize'); ?></div>
                <div class="op-form-field">
            ...
            <div class="">
                <label class="adfo-checkbox bir-checkbox-new-imgs" style="margin-left: 1rem;">
                    ...
                    <span><?php _e('Nice title', 'wptimize'); ?></span>
                </label>
            </div>  
        </div>
        <div class="bir-config-advanced-row js-config-advanced">
            <div class="bir-advanced-row-info"><?php _e('Rename the images. See the documentation for more information', 'wptimize'); ?></div>
            <div class="op-grid-3-col" >
                <div class="op-form-row js-custom-rename">
                    <div class="op-form-label-big"><?php _e('Custom', 'wptimize'); ?></div>
                    <div class="op-form-field">
                ...
                <div class="op-form-row js-custom-rename">
                    <b>[uniqid]</b> <?php _e('Generates a unique id', 'wptimize'); ?><br>
                    <b>[md5]</b> <?php _e('Is replaced with the md5 of the original name', 'wptimize'); ?><br>
                    <b>[id]</b> <?php _e('Is replaced with a sequential number', 'wptimize'); ?> <br>
                    <b>[image_name]</b> <?php _e('Is replaced with the original sanitized image name', 'wptimize'); ?><br>
                    <b>[rand]</b> <?php _e('Generates a random character a-z0-9', 'wptimize'); ?><br>
                  
                   
                </div>
                <div class="op-form-row js-custom-rename">
                    <b>[date]</b> <?php _e('is replaced with the date the image was uploaded', 'wptimize'); ?><br>
                    <b>[time]</b> <?php _e('Is replaced with the time the image was uploaded', 'wptimize'); ?><br>
                    <b>[timestamp]</b> <?php _e('Is replaced with the upload timestamp of the image', 'wptimize'); ?><br>
     ...
     * @since 1.2.0
     */
        do_action( 'wptimize-after-setup-form');
    ?>

</form>

<div class="bir-config-info" style="font-size:.8rem"><?php _e('Be sure to back up your site before using the plugin!', 'wptimize'); ?></div>
